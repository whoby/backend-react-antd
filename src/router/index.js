...
/* 用户管理 */
const UserInfo = asyncComponent(() => import(/* webpackChunkName: "UserInfo" */ '@/views/user/info/index'))
const UserCard = asyncComponent(() => import(/* webpackChunkName: "UserCard" */ '@/views/user/card/index'))
